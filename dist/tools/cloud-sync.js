 ...
 */
import { z } from "zod";
import { fullSync, pushChanges, pullChanges, getSyncStatus, validateLicense } from "../cloud-sync.js";
...
export function registerCloudSyncTools(server) {
    // Sync status
    server.registerTool("knowledge_sync_status", {
        title: "同步状态",
    ...
    // License info
    server.registerTool("knowledge_license", {
        title: "许可证信息",
